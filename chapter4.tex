...
%%%%%%%%%%%%%%% Figura chingona %%%%%%%%%%%%%%%     
    \begin{figure*}[b]
    \centering
    \centerline{\includegraphics[scale=0.4]{figures/Statistical Study/figure13.pdf}}
...
\begin{figure*}[ht!]
    \centering
    \centerline{\includegraphics[scale=0.55]{figures/Statistical Study/figure14.pdf}}
...
%%%%%%%%%%%%%%% Figura chingona %%%%%%%%%%%%%%%     
    \begin{figure*}[ht!]
    \centering
    \centerline{\includegraphics[scale=0.55]{figures/Statistical Study/figure15.pdf}}
...
%%%%%%%%%%%%%%% Figura chingona %%%%%%%%%%%%%%% 
    \begin{figure*}[b]
    \centerline{\includegraphics[scale=0.7]{figures/Casos de uso/figure16.png}}
...
%%%%%%%%%%%%%%% Figura chingona %%%%%%%%%%%%%%%
    \begin{figure*}[ht!]
    \centerline{\includegraphics[scale=0.8]{figures/Casos de uso/figure17.jpg}}
...
%%%%%%%%%%%%%% Figura chingona %%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{figure*}[htbp]
    \centerline{\includegraphics[scale=0.65]{figures/Casos de uso/figure18.jpg}}
