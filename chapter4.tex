...
%%%%%%%%%%%%%%% Figura chingona %%%%%%%%%%%%%%%     
    \begin{figure*}[ht!]
    \centering
    \centerline{\includegraphics[scale=0.55]{figures/figure15.pdf}}
...
Based on this analysis, the following section presents practical use cases for deploying this solution in real-world scenarios, (see \Cref{Comunicación Subacuática,Geolocalización para personas con discapacidad visual en estaciones de trenes,Minería Sostenible}).
