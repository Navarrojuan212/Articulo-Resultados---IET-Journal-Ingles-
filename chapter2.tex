...
This chapter analyzes the current limitations of RF and VLC technologies in indoor environments, with the aim of identifying opportunities to improve wireless communication in these spaces. Section \ref{seccionRFLimitaciones} addresses the tech-RF technologies and their limitations, covering issues such as spectrum saturation, interference, and specific challenges in the implementation of 5G and 6G networks. Section II-B focuses on VLC systems, addressing weaknesses such as their dependence on line of sight, optical interference, and challenges in modulation and bidirectional communication. Section II-C proposes an architecture that links the radio signal capture system, the indoor distribution network, and VLC systems, and discusses the conditions and enabling technologies for hybrid RF-VLC systems and their possible application scenarios.
