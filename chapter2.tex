...
% %%%%%%%%%%%%%%% Figura chingona %%%%%%%%%%%%%%% 
    ...
    \centerline{\includegraphics[scale=0.34]{figures/figure5.pdf}}
...
% \Cref{Componentes del Transmisor Híbrido.}
% \Cref{Componentes del Receptor Híbrido.}
...
the visible light domain \cite{Yeh2015} [132]. 
    ...
    % \begin{figure*}[ht!]
    \begin{figure*}[ht!]
    \centerline{\includegraphics[scale=0.4]{figures/figure7.pdf}}
    ...
    %%%%%%%%%%%%%%% Figura chingona %%%%%%%%%%%%%%% 
    \begin{figure*}[ht!]
        \centerline{\includegraphics[scale=0.4]{figures/figure8.pdf}}
        \caption{Rx Híbrido.}
        \label{Rx-Hibrido}
        % \vspace{10pt} % Espacio opcional entre la leyenda y la línea
        % \rule{\textwidth}{0.2pt} % Mismo ancho que la imagen
