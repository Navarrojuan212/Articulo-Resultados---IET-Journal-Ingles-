...
% Este trabajo plantea experimentalmente un sistema híbrido que combina tecnologías de Radio Frecuencia y Comunicación por Luz Visible para mitigar la no uniformidad de las señales en entornos interiores. Adicionalmente, se presenta un estudio experimental sobre la degradación de la relación señal ruido de una señal de radiodifusión comercial en la frecuencia de 103.5 MHz. Este análisis se llevó a cabo en diferentes niveles de la Institución Universitaria ITM de Medellín, incluyendo sótanos 1 y 2, y se centró exclusivamente en la recepción de la señal. 
% Se compararon los resultados con las mediciones iniciales realizadas, se evidenció que la señal RF pura, captada convencionalmente; presentó una relación señal a ruido con media de 4.93 dB. Tras la implementación del sistema híbrido, la media de la relación señal a ruido aumentó significativamente hasta los 36.9 dB. Estos resultados demuestran la efectividad de la convergencia tecnológica propuesta en este estudio para mejorar la calidad de la señal en múltiples escenarios de aplicación de alta exigencia; como el Internet de las cosas, Ciudades Inteligentes, Posicionamiento en interiores, Minería Sostenible, Monitoreo Marino y otros.
