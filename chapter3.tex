...
%%%%%%%%%%%%%%% Figura chingona %%%%%%%%%%%%%%%     
    \begin{figure*}[ht!]
    \centering
    \centerline{\includegraphics[scale=0.52]{figures/RF-VLC/RFSignal-diagrama.pdf}}
    \caption{Señal RF tomada desde el exterior y conectada al sistema VLC.}
    \label{Antenayagi}
    \end{figure*}    
%%%%%%%%%%%%%%% Figura chingona %%%%%%%%%%%%%%%

En este capítulo se describe, de manera detallada, la metodología seguida para lograr la convergencia entre un enlace de radiodifusión y un sistema de comunicación por luz visible. El proceso inicia con la captura de la señal comercial de FM situada en los 103.5 MHz en la ciudad de Medellin a través de una antena Yagi instalada en la terraza del cuarto piso del campus universitario ITM Fraternidad (ver esquema de la \Cref{Antenayagi}). Esta señal se conectó directamente a una USRP, que en conjunto con GNU Radio, permitió su procesamiento y posterior retransmisión a una frecuencia de 140 MHz. 
% %%%%%%%%%%%%%%% Figura chingona %%%%%%%%%%%%%%%     
%     \begin{figure}[ht!]
%     \centering
%     \centerline{\includegraphics[scale=0.5]{figures/RF-VLC/RFSignal-diagrama.pdf}}
%     \caption{Señal RF tomada desde el exterior y conectada al sistema VLC.}
%     \label{Antenayagi}
%     \end{figure}    
% %%%%%%%%%%%%%%% Figura chingona %%%%%%%%%%%%%%%
...
\begin{figure*}[htbp]
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[scale=0.6]{figures/RF-VLC/Senal In Amplificador Tx 140MHz.jpg}
    ...
    \hfill
        \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[scale=0.6]{figures/RF-VLC/Senal Out Amplificador Tx 140MHz.jpg}
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[scale=0.6]{figures/RF-VLC/Senal Out Mixer Tx 2MHz.jpg}
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[scale=0.6]{figures/RF-VLC/Senal Out BiasT Tx 2MHz.jpg}
...
\begin{figure*}[htbp]
    \centering
        \begin{subfigure}{0.45\textwidth}
            \centering
            \includegraphics[scale=0.6]{figures/RF-VLC/Senal Rcibida Sin Lente 140MHz.jpg}
    ...
    \hfill
        \begin{subfigure}{0.45\textwidth}
            \centering
            \includegraphics[scale=0.6]{figures/RF-VLC/Senal In Amplificador Rx 2MHz.jpg}
    ...
    \vspace{0.2cm}
        \begin{subfigure}{0.45\textwidth}
            \centering
            \includegraphics[scale=0.6]{figures/RF-VLC/Senal Out Amplificador Rx 2MHz.jpg}
    ...
    \hfill
        \begin{subfigure}{0.45\textwidth}
            \centering
            \includegraphics[scale=0.6]{figures/RF-VLC/Senal Rcibida Lente 140MHz.jpg}
...
%%%%%%%%%%%%%%% Figura chingona %%%%%%%%%%%%%%% 
    \begin{figure*}[ht!]
    \centerline{\includegraphics[scale=0.45]{figures/ITM_.png}}
